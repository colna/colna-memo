...
```
memory/            真源 Markdown(入 git);PARA 结构,约定见 CONVENTIONS.md
  00-Inbox/        收件箱(colna add 默认落这)
  10-Projects/     项目  20-Areas/ 领域  30-Resources/ 资源
  40-Archive/      归档  50-Daily/ 日记
  _templates/      模板  _attachments/ 附件(_ 开头不入索引)
.colna/            本地派生(不入 git)
